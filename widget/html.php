...
class midgardmvc_helper_forms_widget_html extends midgardmvc_helper_forms_widget_textarea
{
    ...
    {    
        ...
        $html .= "<script type='text/javascript'>jQuery(function() {jQuery('.{$this->field->get_name()}').wymeditor({updateSelector: '.midgardmvc_helper_forms_form_save', skin: 'compact'});});</script>";
